...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">Skills required</td>
                <td>
            ...
            <tr>
                <td class="auto-style2">Programming languages known </td>
                <td>
            ...
            <tr>
                <td class="auto-style2">Number of vaccancies</td>
                <td>
                    <asp:TextBox ID="TextBox10" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">Last date to apply </td>
                <td>
        ...
        <p>
                    <asp:Button ID="Button1" runat="server" Text="push to database" OnClick="Button1_Click" />
                </p>
    </form>
</body>
</html>
